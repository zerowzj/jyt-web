    ...
    <form id="_form" action="/system/pwdModify" method="post">
        <table border="1" width="100%" class="table_a">
            <tr>
                ...
                <td ><input type="text" name="jytLoginName" datatype="s6-16" nullmsg="请输入新密码！"></td>
            </tr>
            <tr>
                <td><span class="need">*</span>京医通登录密码</td>
                <td><input type="password" name="jytLoginPwd" datatype="s6-16" nullmsg="请输入确认新密码！" recheck='ubLoginPwd'></td>
            </tr>
            <tr>
